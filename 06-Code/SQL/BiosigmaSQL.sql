/*==============================================================*/
/* Database name:  biosigma_db                                  */
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     18/5/2025 21:19:33                           */
/*==============================================================*/


drop database if exists biosigma_db;

/*==============================================================*/
/* Database: biosigma_db                                        */
/*==============================================================*/
...
alter table PROJECT_CUSTOMER add constraint FK_REFERENCE_13 foreign key (USERS_ID)
      references USERS (USERS_ID) on delete restrict on update restrict;

alter table PROJECT_CUSTOMER add constraint FK_REFERENCE_14 foreign key (PROJECT_ID)
      references PROJECT (PROJECT_ID) on delete restrict on update restrict;
